...
export declare const defaultIntegrations: (Console | Http | OnUncaughtException | OnUnhandledRejection | ContextLines | LinkedErrors | CoreIntegrations.InboundFilters | CoreIntegrations.FunctionToString)[];
/**
