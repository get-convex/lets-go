...
function extractTraceDataFromMetaTags() {
  ...
  var sentrytraceData = sentrytraceValue ? utils.extractTraceparentData(sentrytraceValue) : undefined;
  var baggage = baggageValue ? utils.parseBaggageString(baggageValue) : undefined;
