import { DocumentByInfo, GenericDocument, GenericIndexFields, GenericTableInfo, IndexNames, NamedIndex } from "./data_model.js";
 ...
 * @public
 */
export interface Table<TableInfo extends GenericTableInfo> extends Query<DocumentByInfo<TableInfo>> {
    /**
 ...
 * @public
 */
export interface IndexedQuery<Document extends GenericDocument, IndexFields extends GenericIndexFields> {
    /**
 ...
 * @public
 */
export interface Query<Document extends GenericDocument> extends OrderedQuery<Document> {
    /**
 ...
 * @public
 */
export interface OrderedQuery<Document extends GenericDocument> extends AsyncIterable<Document> {
    /**
