    ...
    onResponse(response) {
        ...
        if (mutationInfo.status.status === "Requested") {
            ...
            for (const line of response.logLines) {
                (0, logging_js_1.logToConsole)("info", "mutation", udfPath, line);
            }
            if (response.success) {
                mutationInfo.status.onResult((0, common_1.jsonToConvex)(response.result));
                mutationInfo.status = {
                    status: "Committed",
                    ts: response.ts,
                };
                ...
                (0, logging_js_1.logToConsole)("error", "mutation", udfPath, response.result);
                mutationInfo.status.onFailure((0, logging_js_1.createError)("mutation", udfPath, response.result));
