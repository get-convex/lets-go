...
exports.OptimisticQueryResults = void 0;
...
class OptimisticLocalStoreImpl {
    ...
    getQuery(name, args) {
        const query = this.queryResults.get((0, udf_path_utils_js_1.serializePathAndArgs)(name, args));
        if (query === undefined) {
            return undefined;
        }
    ...
    setQuery(name, args, value) {
        const queryToken = (0, udf_path_utils_js_1.serializePathAndArgs)(name, args);
        let result;
        if (value === undefined) {
            result = undefined;
        }
...
class OptimisticQueryResults {
    ...
    queryResult(queryToken) {
        ...
        if (result === undefined) {
            ...
            throw (0, logging_js_1.createError)("query", query.udfPath, result.errorMessage);
        }
    }
}
exports.OptimisticQueryResults = OptimisticQueryResults;
