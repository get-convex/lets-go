...
import { provisionHost, readInstanceConfig, configName, envFilename, } from "./config.js";
import { version } from "../index.js";
import { BETA_KEY_DEPRECATION_MESSAGE, BETA_KEY_OPTION, deprecationCheck, flushAndExit, getAuthHeader, printServerErr, prompt, } from "./utils.js";
import fs from "fs";
export const deactivate = new Command("deactivate")
    ...
    console.log(chalk.red("Data on this deployment will no longer be accessible after deactivation."));
    if (!options.force) {
        await prompt("Are you sure you want to deactivate this deployment?\nPress enter to continue or ctrl-C to abort.\n");
    }
    ...
    try {
        ...
        console.log(chalk.green(`Done! Your account now has ${res.data.redemptionsRemaining} deployments remaining.`));
    }
    catch (err) {
