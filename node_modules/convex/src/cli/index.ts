...
if (process.platform === "win32") {
  console.log(
    chalk.red(
      "The Convex CLI does not currently support Windows. Read the docs for more information: https://docs.convex.dev/understanding/beta-state#windows-development."
    )
  );
}
