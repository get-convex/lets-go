...
import { AuthInfo, readInstanceConfig, writeInstanceConfig } from "./config.js";
        ...
        .prompt([
          {
            ...
            name: "domain",
            message:
              "Enter the identity provider's URL, (e.g. `https://accounts.google.com`):",
            validate: iss => {
...
export const auth = new Command("auth")
  ...
  .option(
    ...
    "Type of deployment to edit the config for (`convex.<type>.json`). Defaults to `convex.json`"
  )
