...
export const dashboard = new Command("dashboard")
  .description(
    "Log into Convex with the local `.env.local` file and open the dashboard in the browser"
  )
  .option(
    "--no-open",
  ...
  .option(
    ...
    "Type of deployment to show dashboard for (`convex.<type>.json`). Defaults to `convex.json`"
  )
